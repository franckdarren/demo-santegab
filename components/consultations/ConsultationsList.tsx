...
// Statuts avec labels, couleurs et icônes
const STATUT_CONFIG: Record<StatutConsultation, { label: string; color: string; icon: React.ElementType }> = {
...
export function ConsultationsList({
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Barre de recherche + bouton nouvelle consultation */}
            ...
            {/* Dialog détail / modification consultation */}
